...
display = Display()
player = Character([-175, 0], [-175, 0], [0, 0], 15, "gajjupng.gif")
harm1 = Character([-125, 0], [-125, 0], [0, -.2], 25, "bank.gif")
harm2 = Character([-75, 0], [-75, 0], [0, .15], 25, "bank.gif")
harm3 = Character([-25, 0], [-25, 0], [0, .2], 25, "bank.gif")
harm4 = Character([25, 0], [25, 0], [0, .075], 25, "bank.gif")
harm5 = Character([75, 0], [75, 0], [0, -.13], 25, "bank.gif")
harm6 = Character([125, 0], [125, 0], [0, .1], 25, "bank.gif")
door = Character([175, 100], [175, 100], [0, 0], 25, "momopng.gif")
